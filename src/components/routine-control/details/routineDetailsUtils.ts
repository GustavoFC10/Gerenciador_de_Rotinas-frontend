import type { TaskAttachment } from '../../../types/domain'

type AttachmentSource = Omit<TaskAttachment, 'id'> & { id?: string }

interface AttachmentTaskSource {
  id: string
...
export function getRoutineAttachments(
  task: AttachmentTaskSource,
): TaskAttachment[] {
